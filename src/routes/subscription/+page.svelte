...
<div class="container">
  ...
  <div class="flip-card">
    <div class="flip-card-inner">
        <div class="flip-card-front">
            <p class="heading_8264">FOODSTOCKCARD</p>
            ...
            <p class="valid_thru">FOUNDED IN</p>
            <p class="date_8264">09 / 2 3</p>
            <p class="name">ROBIN AUGEREAU</p>
        </div>
  ...
  <div class="card">
    <div class="header">
      <span class="title">{translate("Sub.Cheap")}</span>
      <span class="price">{translate("Sub.CheapPrice")}</span>
    </div>
    <p class="desc">{translate("Sub.CheapDesc")}</p>
    <ul class="lists">
      <li class="list">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
        </svg>
        <span>{translate("Sub.1S")}</span>
      </li>
    </ul>
  ...
  <div class="card">
    <div class="header">
      <span class="title">{translate("Sub.Paid")}</span>
      <span class="price">{translate("Sub.PaidPrice")}</span>
    </div>
    <p class="desc">{translate("Sub.PaidDesc")}</p>
    <ul class="lists">
      <li class="list">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
        </svg>
        <span>{translate("Sub.Unlimited")}</span>
      </li>
    </ul>
    <button type="button" class="action">Get Started</button>
  </div>
